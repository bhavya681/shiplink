...
const PrivateChat = () => {
  ...
  return (
    <div className="flex flex-col h-screen bg-gray-50 shadow-md shadow-gray-700 mt-20 overflow-hidden">
      {/* Premium Chat Header */}
      <motion.div
                      ...
                      >
                        ...
                        {/* {msg.sender._id === user1 ? (
                          <div className="absolute -right-[6px] top-0 w-3 h-3 overflow-hidden">
                            <div className="absolute -left-[6px] w-3 h-3 bg-[#00a884] transform rotate-45"></div>
                          </div>
                        ) : (
                          <div className="absolute -left-[6px] top-0 w-3 h-3 overflow-hidden">
                            <div className="absolute -left-[6px] w-3 h-3 bg-white transform rotate-45 shadow-sm"></div>
                          </div>
                        )} */}
                      </motion.div>
                      {msg.sender._id === user1 && (
